...
# Your secret key is salted using a randomly generated salt. The default length of the salt is 8 characters but you can alter this via a "pref":#smd_akey_prefs
...
bc(block). http://site.com/music/next-big-hit/demo/
...
bc(block). <txp:smd_access_protect expires="86400" trigger="demo" force="1" />
...
bc(block). <txp:smd_access_protect expires="86400" trigger="demo">
...
; %(atnm)File download expiry time%
...
bc(block). <txp:smd_access_protect
...
bc(block). Thank you for registering with <txp:site_name />.
...
bc(block). <txp:smd_access_protect trigger="user_id."
...
bc(block). <txp:smd_access_key url="/account/activate/" max="1"
